export const EXPERIENCES = [
  {
    ...
    description: `Desarrollo y mantenimiento de microservicios para la Junta de Andalucía en el sector agrícola, participando en proyectos como Jano (gestión de trámites y documentos), Iris (sistema de notificaciones) y la PDA (Plataforma Digital Agraria).
